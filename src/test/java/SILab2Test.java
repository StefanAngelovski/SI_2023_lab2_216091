...
public class SILab2Test {
    ...
    public void testMultipleCondition() {
        ...
        // Scenario 5: First condition is false, second condition is true, third condition is true
        User user5 = new User("username", null, null);
        List<User> allUsers = new ArrayList<>();
        boolean result1 = SILab2.function(user5, allUsers);
        Assertions.assertFalse(result1);

        // Scenario 6: First condition is false, second condition is false, third condition is true
        User user6 = new User("username", "password", null);
        boolean result2 = SILab2.function(user6, allUsers);
        Assertions.assertFalse(result2);

        // Scenario 7: First condition is false, second condition is true, third condition is false
        User user7 = new User("username", null, "email");
        boolean result3 = SILab2.function(user7, allUsers);
        Assertions.assertFalse(result3);

        // Scenario 8: First condition is false, second condition is false, third condition is false
